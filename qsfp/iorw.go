...
func (r *regio8) get(h *qsfpI2cDev) {
	var data = [34]byte{0, 0, 0, 0}
...
func (r *regio16) get(h *qsfpI2cDev) {
	var data = [34]byte{0, 0, 0, 0}
...
func (r *regio16r) get(h *qsfpI2cDev) {
	var data = [34]byte{0, 0, 0, 0}
...
func (r *regio8) set(h *qsfpI2cDev, v uint8) {
	var data = [34]byte{0, 0, 0, 0}
...
func (r *regio16) set(h *qsfpI2cDev, v uint16) {
	var data = [34]byte{0, 0, 0, 0}
...
func (r *regio16r) set(h *qsfpI2cDev, v uint16) {
	var data = [34]byte{0, 0, 0, 0}
