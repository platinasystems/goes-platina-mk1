...
func (r *reg8b) get(h *qsfpI2cDev, readLen byte) {
	var data = [34]byte{0, 0, 0, 0}
...
func (r *reg16r) get(h *qsfpI2cDev) {
	var data = [34]byte{0, 0, 0, 0}
...
func (r *reg8) set(h *qsfpI2cDev, v uint8) {
	var data = [34]byte{0, 0, 0, 0}
...
func (r *reg16) set(h *qsfpI2cDev, v uint16) {
	var data = [34]byte{0, 0, 0, 0}
...
func (r *reg16r) set(h *qsfpI2cDev, v uint16) {
	var data = [34]byte{0, 0, 0, 0}
